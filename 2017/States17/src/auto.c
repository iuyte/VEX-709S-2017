...
void autonomous() {
  ...
  TaskHandle liiftToTask3 = taskCreate(liftToTask, TASK_DEFAULT_STACK_SIZE, (void*) arr, TASK_PRIORITY_DEFAULT);
  delay(1500);
  liftSet(-50);
  delay(250);
  liftSet(0);
  ...
  driveInch(34, 127);
  arr[1] = potHalf + 200;
  TaskHandle liftToTask4 = taskCreate(liftToTask, TASK_DEFAULT_STACK_SIZE, (void*) arr, TASK_PRIORITY_DEFAULT);
  driveInch(6, 127);
  delay(250);
  driveSet(-127, -127);
  timerReset(0);
